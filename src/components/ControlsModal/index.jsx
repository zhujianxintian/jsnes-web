...
class ControlsModal extends Component {
    constructor(props) {
        ...
        this.state.controllerIcon = this.state.gamepadConfig.playerGamepadId.map((gamepadId) =>
            gamepadId ? GAMEPAD_ICON : KEYBOARD_ICON,
        );
        this.state.controllerIconAlt = this.state.gamepadConfig.playerGamepadId.map((gamepadId) =>
    ...
    render() {
        return (
            <Modal isOpen={this.props.isOpen} toggle={this.props.toggle} className="ControlsModal">
