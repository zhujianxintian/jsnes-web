...
const config = {
    ROMS: {
        owlia: {
            ...
            description: (
                <span>
                    ...
                    /{' '}
                    <a href="http://www.infiniteneslives.com/owlia.php" target="_blank" rel="noopener noreferrer">
                        Buy the cartridge
                    </a>
                </span>
            ),
        ...
        nomolos: {
            ...
            description: (
                <span>
                    ...
                    /{' '}
                    <a href="http://www.infiniteneslives.com/nomolos.php" target="_blank" rel="noopener noreferrer">
                        Buy the cartridge
                    </a>
                </span>
            ),
        ...
        croom: {
            ...
            description: (
                <span>
                    <a href="http://www.pineight.com/croom/README" target="_blank" rel="noopener noreferrer">
                        Concentration Room
                    </a>{' '}
                    by Damian Yerrick
                </span>
        ...
        lj65: {
            ...
            description: (
                <span>
                    <a href="http://harddrop.com/wiki/LJ65" target="_blank" rel="noopener noreferrer">
                        Concentration Room
                    </a>{' '}
                    by Damian Yerrick
                </span>
